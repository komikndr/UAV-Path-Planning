...
\chapter{Introduction}
    \section{Introduction}
	    ...
	    booming of UAV is caused by the component needed to manufacture the UAV, especially microcontrollers
	    ...
	    deployable without requiring many technicians to maintain them.
		    ...
		    UAV are often being used in area where it is dangerous, impractical, and expensive for human. The
	    affordable entry point of using a UAV incentivized emerging industries to exploit the capability that UAV
	    offer. Not only that but the existing industry is also getting interested to use UAV as an augmentation to
        ...
        aircraft. Many countries have regulations in place that require UAV to be operated in a safe and
        responsible manner. Risk-based UAV path planner can help to ensure that UAV are operated safely and
        ...
        establishing rules around the use of UAV in sensitive areas.
...
\chapter{Literature Review}
    ...
    \section{Components of ground risk model}
        ...
        \subsection{Failure model}
            ...
            interpolation and extrapolation for calculating \ac{MTBF} \cite{breunig_modeling_nodate} and \cite{weibel_safety_nodate} for example.
...
\chapter{Background Theory and Methodology}
    \section{General Overview}
        ...
        To collect necessary data, we are using free services provided by \ac{OSM} \cite{noauthor_openstreetmap_nodate} to retrieve geographic
        data, and \ac{GHSL} \cite{noauthor_global_nodate} to retrieve population density throughout the earth.
