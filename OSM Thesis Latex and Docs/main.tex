...
\chapter{Literature Review}
    \section{Overview}
        ...
        Finder. First, we will examine the Ground Risk Model, which involves discussing the concept of probability
        within a spatial context. Consider this scenario: if we want to calculate the likelihood of someone being hit by
        a drone in a specific location, how do we model this phenomenon? As you can see, scenarios like this are key to
        understanding the Ground Risk Model.
        ...
        management strategies for UAV operations.
            ...
            There are a number of different approaches that have been taken to develop the ground risk models for UAV.
    ...
    \section{Ground risk model}
        ...
        A ground risk model for unmanned aerial vehicles (UAV) typically consists of several subcomponents that are
        used to assess the various factors that can impact the safety and effectiveness of UAV operations. However, this
        approach is not new, since many earlier researches already follow a guideline to model these components. \cite{breunig_modeling_2018}
        provide general guideline for the model, while \cite{washington_review_2017} provide a detailed description for
        the model. \cite{washington_review_2017} method of compilation is based on \cite{pat-cornell_uncertainties_1996}, which studied the level of
