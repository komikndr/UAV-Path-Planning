...
\pagenumbering{roman}
    ...
    \addcontentsline{toc}{chapter}{Examiner Approval Page}
        \begin{center}
        {\textbf{DEVELOPMENT OF RISK-INFORMED UAV PATHFINDER BASED ON A* ALGORITHM}}\par\vspace{0.1cm}
        \textbf{Micko Lesmana}\par
        {11201901010}\par
    ...
    \addcontentsline{toc}{chapter}{Statement of the Author}
...
\chapter{Results}
    ...
    \section{Pathfinder result}
        ...
        \begin{table}[H]
            \centering
            \caption{Pathway Risk Statistic in \% probability} % Caption at the bottom
        ...
        \begin{table}[H]
            \centering
            \caption{Areal map risk statistic of North Jakarta in (\%) probability} % Caption at the bottom
            \resizebox{0.9\textwidth}{!}{
            \begin{tabular}{|llllll|}
                \hline
                \textbf{} & \textbf{Talon} & \textbf{Disco} & \textbf{Phantom 4} & \textbf{Inspire 2} & \textbf{Normal A*} \\
                \hline
                {Avg Ballistic impact (\%)} & \(2.28 \times 10^{-3}\) & \(2.25 \times 10^{-3}\) & \(2.35 \times 10^{-3}\) & \(2.24 \times 10^{-3}\) & 0 \\
                {Avg Fly away impact (\%)} & \(4.1 \times 10^{-5}\) & \(9.3 \times 10^{-5}\) & \(4.44 \times 10^{-4}\) & \(1.69 \times 10^{-4}\) & 0 \\
                {Avg Glide impact (\%)} & \(2.33 \times 10^{-3}\) & \(2.44 \times 10^{-3}\) & \(2.44 \times 10^{-3}\) & \(2.33 \times 10^{-3}\) & 0 \\
                {Avg Parachute impact (\%)} & \(2.48 \times 10^{-3}\) & \(2.46 \times 10^{-3}\) & \(2.47 \times 10^{-3}\) & \(2.48 \times 10^{-3}\) & 0 \\
                {Avg Total fatality (\%)} & \(4.62 \times 10^{-5}\) & \(4.74 \times 10^{-5}\) & \(5.23 \times 10^{-5}\) & \(4.74 \times 10^{-5}\) & 0 \\
                {Fatality per flight hours (\%/h)} & \(9.57 \times 10^{-3}\) & \(9.91 \times 10^{-3}\) & \(1.08 \times 10^{-2}\) & \(9.81 \times 10^{-3}\) & 0 \\
                {Travel distance (m)} & 4,918 & 5,121 & 5,066 & 5,147 & 4,903 \\
                {Average path risk (\%)} & \(1.48 \times 10^{-4}\) & \(1.48 \times 10^{-4}\) & \(1.65 \times 10^{-4}\) & \(1.49 \times 10^{-4}\) & \(1.74 \times 10^{-4}\) \\
                \hline
            \end{tabular}
            }
