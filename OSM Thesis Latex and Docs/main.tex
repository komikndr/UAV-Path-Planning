...
\chapter{Literature Review}
    ...
    \section{Ground risk model}
        ...
        \subsection{Impact location model}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=\textwidth]{General Image/OSM Drone-Area Exposed.pdf}
            ...
            Here \(A_{exp}\) is an area exposed in \(m^2 \), $r_p$ and \(h_p\) is the average radius (0.3 \(m\)) and
